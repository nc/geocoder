...
describe Geocoder::YahooGeocoder do
  it "should be able to parse a Yahoo geocoding API response" do
    ...
    response = Geocoder::YahooGeocoder.new.parse(Crack::XML.parse(sample_response))
    response.status.should == "OK"

    result = response.results.first
    result.formatted_address.should == "1600 Pennsylvania Ave NW, Washington, DC  20006, US"
